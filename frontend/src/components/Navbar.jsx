...
export default function Navbar() {
  ...
  // fetch current user on location change
  useEffect(() => {
    axios
  ...
  const Dropdown = ({ name, label, items }) => (
    <div className="relative">
      <button
        ...
        className={`
          flex items-center gap-1 rounded bg-gray-800 px-3 py-2 hover:bg-gray-700 transition
        ...
        <div className="flex items-center space-x-4">
          {!username ? (
            ...
            <div className="relative">
              ...
              {openMenu === "user" && (
                <ul className="absolute right-0 mt-1 w-40 rounded bg-gray-800 shadow-lg z-20">
                  <MenuItem to="/stats" label="Stats" />
